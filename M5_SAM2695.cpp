...
// Joe Nagata
void M5_SAM2695::sendClock() {
  uint8_t CMD_TIMING_CLOCK[] = { MIDI_CMD_TIMING_CLOCK };
  sendCMD(CMD_TIMING_CLOCK, sizeof(CMD_TIMING_CLOCK));
};

void M5_SAM2695::sendStart() {
  uint8_t CMD_START[] = { MIDI_CMD_START };
  sendCMD(CMD_START, sizeof(CMD_START));
};

void M5_SAM2695::sendStop() {
  uint8_t CMD_STOP[] = { MIDI_CMD_STOP };
